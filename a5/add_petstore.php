...
<meta charset="utf-8">
	...
	<meta name="author" content="Juan Abreut">
			...
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2">
					...
					<h2>Pet Stores</h2>
						...
						<form id="LIS4381_Form" method="post" class="form-horizontal" action="add_petstore_process.php">
								<div class="form-group">
										<label class="col-sm-3 control-label">Name:</label>
										<div class="col-sm-5">
											<input type="text" class="form-control" name="name" placeholder="(max 30 characters)" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="street" placeholder="(max 30 characters)" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="city" placeholder="(max 30 characters)" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="state" placeholder="Example: FL" maxlength="2"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="zip" placeholder="(5 or 9 digits no dashes)" maxlength="9"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="phone" placeholder="(10 digits no other characters)" maxlength="10"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="email" placeholder="Example: jdoe@aol.com" maxlength="100"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="url" placeholder="Example: www.jdoe.com" maxlength="100"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="ytdsales" placeholder=" Example 109.99 (no other characters)" maxlength="10"/>
										</div>
								</div>
