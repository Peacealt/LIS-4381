					...
					<h2>Pet Stores</h2>
						...
						<form id="edit_petstore" method="post" class="form-horizontal" action="edit_petstore_process.php">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="name" value="<?php echo $result['pst_name']; ?>" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="street" value="<?php echo $result['pst_street']; ?>" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="city" value="<?php echo $result['pst_city']; ?>" maxlength="30"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="state" value="<?php echo $result['pst_state']; ?>" maxlength="2"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="zip" value="<?php echo $result['pst_zip']; ?>" maxlength="9"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="phone" value="<?php echo $result['pst_phone']; ?>" maxlength="10"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="email" value="<?php echo $result['pst_email']; ?>" maxlength="100"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="url" value="<?php echo $result['pst_url']; ?>" maxlength="100"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control" name="ytdsales" value="<?php echo $result['pst_ytd_sales']; ?>" maxlength="21"/>
										</div>
								</div>
